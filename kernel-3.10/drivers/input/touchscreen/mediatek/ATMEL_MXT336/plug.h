...
#define CONFIG_DUMMY_PARSE_DTS  //swf66


//#define CONFIG_MXT_CAL_T37_SC_WORKAROUND
#define CONFIG_MXT_MISC_WORKAROUND
//#define CONFIG_MXT_CLIP_WORKAROUND   //swf delete
...
#include "plugin_clip.h"
				       ...
				       /*************** sunwf delete222 start ******************/
#define CONFIG_MXT_PLUGIN_SUPPORT  //swf add
...
#endif
#endif                                /****************** sunwf delete222 *********************/

#define MXT_PAGE_SIZE 64
#define MXT_THR_ADJ  //michael
...
struct plugin_misc{
	...
	//void (*hook_reg_init)(struct plugin_misc *p);
	int (*get_pid_val)(struct plugin_misc *p, u8 *id, int len);
