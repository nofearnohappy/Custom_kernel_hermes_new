...
UINT32 OV5670LITE_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
//lenovo.sw END wangsx3 add for AIO backup sub_camera
...
//lenovo.sw START wangsx3 config k5 camera
UINT32 S5K3M2_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
//lenovo.sw END wangsx3 config k5 camera
//lenovo.sw START wuyt3 config k5 2nd camera
UINT32 S5K3M2_2ND_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
//lenovo.sw END wuyt3 config k5 2nd camera
...
UINT32 OV13850SUNNY_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 OV13850OFILM_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 OV13850OFILMA50_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
//yixuhong 20150718 add tinno camera start 
UINT32 OV5648MIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 OV5648MIPISensorInit_darling(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 OV5648MIPISensorInit_sunwin(PSENSOR_FUNCTION_STRUCT *pfFunc);
//yixuhong 20150718 add tinno camera end

//added for aio_row
UINT32 HI551QTECH_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 IMX219OFILM_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 HI551QTECHV2_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
//ended
...
//lenovo.sw START wangsx add for AIO
    ...
    {OV13850SUNNY_SENSOR_ID, SENSOR_DRVNAME_OV13850SUNNY_MIPI_RAW, OV13850SUNNY_MIPI_RAW_SensorInit}, 
#endif
#if defined(OV13850OFILM_MIPI_RAW)
    {OV13850OFILM_SENSOR_ID, SENSOR_DRVNAME_OV13850OFILM_MIPI_RAW, OV13850OFILM_MIPI_RAW_SensorInit}, 
#endif
#if defined(OV13850OFILMA50_MIPI_RAW)
    {OV13850OFILMA50_SENSOR_ID, SENSOR_DRVNAME_OV13850OFILMA50_MIPI_RAW, OV13850OFILMA50_MIPI_RAW_SensorInit}, 
#endif
//lenovo.sw END wangsx add for AIO
//yixuhong 20150718 add tinno camera start
...
#endif
#if defined(OV5648_MIPI_RAW_DARLING)
    {OV5648MIPI_SENSOR_ID_DARLING, SENSOR_DRVNAME_OV5648_MIPI_RAW_DARLING, OV5648MIPISensorInit_darling},
#endif
#if defined(OV5648_MIPI_RAW_SUNWIN)
    {OV5648MIPI_SENSOR_ID_SUNWIN, SENSOR_DRVNAME_OV5648_MIPI_RAW_SUNWIN, OV5648MIPISensorInit_sunwin},
#endif
//yixuhong 20150718 add tinno camera end
/*SONY*/
/*IMX*/
...
#endif
//lenovo.sw START wangsx3 add for AIO backup sub_camera
#if defined(OV5670LITE_MIPI_RAW)
    {OV5670LITEMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5670LITE_MIPI_RAW, OV5670LITE_MIPI_RAW_SensorInit},
#endif
//lenovo.sw END wangsx3 add for AIO backup sub_camera
...
#endif
#if defined(IMX219OFILM_MIPI_RAW)
    {IMX219_SENSOR_ID, SENSOR_DRVNAME_IMX219OFILM_MIPI_RAW, IMX219OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(HI551QTECH_MIPI_RAW)
    {HI551_SENSOR_ID, SENSOR_DRVNAME_HI551QTECH_MIPI_RAW,HI551QTECH_MIPI_RAW_SensorInit},
#endif
#if defined(HI551QTECHV2_MIPI_RAW)
    {HI551QTECHV2_SENSOR_ID, SENSOR_DRVNAME_HI551QTECHV2_MIPI_RAW,HI551QTECHV2_MIPI_RAW_SensorInit},
#endif
