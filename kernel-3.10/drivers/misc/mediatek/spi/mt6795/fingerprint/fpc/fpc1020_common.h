...
//yongqiang start
#define EINT9                      9
#define FPC1020_INT_IRQNO       EINT9
#define FPC1020_IRQ_GPIO        (GPIO9 | 0x80000000)
#define FPC1020_RESET_GPIO      (GPIO192 | 0x80000000)
#define CUST_EINT_FPC_TYPE      CUST_EINTF_TRIGGER_RISING
#define RSUCCESS   0
