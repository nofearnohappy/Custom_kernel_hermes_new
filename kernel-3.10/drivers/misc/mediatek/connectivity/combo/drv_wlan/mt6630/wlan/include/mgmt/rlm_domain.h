...
#define COUNTRY_CODE_MF (((UINT_16) 'M' << 8) | (UINT_16) 'F') /* Saint Martin / Sint Marteen (Added on window's list)                   */
...
#define COUNTRY_CODE_MP (((UINT_16) 'M' << 8) | (UINT_16) 'P') /* Northern Mariana Islands (Rota Island. Saipan and Tinian Island)       */
...
#define POWER_LIMIT_NUM  5  //PwrLimit : cck, 20M, 40M, 80M, 160M 
#define MAX_COUNTRY_NUM  128
